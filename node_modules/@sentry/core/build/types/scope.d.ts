...
import type { Attachment, Breadcrumb, Context, Contexts, DynamicSamplingContext, Event, EventHint, EventProcessor, Extra, Extras, Primitive, PropagationContext, RequestEventData, Session, SeverityLevel, Span, User } from './types-hoist';
/**
