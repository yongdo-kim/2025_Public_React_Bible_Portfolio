...
const PrivacyPolicyPage = () => {
  return (
    <Column>
      <NavBar />
      <Layout>
        <MainText className="text-3xl">Privacy Policy for 하루 성경</MainText>
        <SubText>
          Privacy Policy
          <br />
          ...
          this Agreement) refers to 하루 성경.
          <br />
          ...
          <br />
          Website refers to 하루 성경, accessible from
          ...
          us:
          <br />
          By email: naristudio2023@gmail.com
        </SubText>
      </Layout>
    </Column>
  );
