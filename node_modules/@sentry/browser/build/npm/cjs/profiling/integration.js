      ...
      client.on('beforeEnvelope', (envelope) => {
        ...
        for (const profiledTransaction of profiledTransactionEvents) {
          ...
          if (typeof profile_id !== 'string') {
            debugBuild.DEBUG_BUILD && core.logger.log('[Profiling] cannot find profile for a span without a profile context');
            continue;
          }
          ...
          if (!profile) {
            debugBuild.DEBUG_BUILD && core.logger.log(`[Profiling] Could not retrieve profile for span: ${profile_id}`);
            continue;
          }
